...
class LambdaTest {
	...
	public void testeTrim() {
		...
		assertEquals("[ADAS, DSFKOEUE, F, SDSSFJHB, BFJKH, IDKUSHGF]", _stream.manipulating(mehrWorte).toString());
	}
	...
	public void umlaute() {
		...
		assertEquals("[AEOEUEAE, DOEAEUEO, F, OEUEAEOE, BFJKH, SSSSSSSS]", _stream.manipulating(mehrWorte).toString());
	}
	...
	public void nullen() {
		...
		assertEquals("[NULL, ASDFASDW, F, WADAS, BFJKH, ADSW]", _stream.manipulating(mehrWorte).toString());
	}
